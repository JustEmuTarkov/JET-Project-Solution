...
{
    /// <summary>
    /// Patch that disables SSL certificate validation and sets it to accepts every request/response
    /// </summary>
    class NotificationSsl : GenericPatch<NotificationSsl>
    {
        ...
        public NotificationSsl() : base(transpiler: nameof(PatchTranspiler)) { }
        ...
        /* what's going on here?
           ...
           Found GClass has a nested class that is an IEnumerator. In its MoveNext method, there is a particular bit of code that creates
